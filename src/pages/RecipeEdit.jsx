...
class _RecipeEdit extends Component {
    ...
    // onSetIngredients = (value) => {
        ...
        // }
        // let newIngridents = value.currentTarget.value.trim().split('\n')
        // this.setState(prevState => {
        //     let newIngridents = [...this.state.recipe.ingredients]
        //     return {
        //         recipe: {
        //             ...prevState.recipe,
                ...
                <div className="edit-recipe">
                    <form className="edit-form flex space-around" onSubmit={this.onSaveRecipe}>
                        <section className="edit-right-side flex column">
                            ...
                            <TextField type="text" variant="outlined" label="Ingredients" multiline rows={4} name="ingredientAmount" onChange={this.onSetIngredients} defaultValue={ingredientAmount} /> */}
